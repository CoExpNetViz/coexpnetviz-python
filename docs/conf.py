...
intersphinx_mapping = {
    ...
    'varbio': ('http://varbio.readthedocs.io/en/2.0.0/', None),
}
...
texinfo_documents = [
    (master_doc, pypi_name, project + ' Documentation',
     author, pypi_name, 'Comparative co-expression network construction and visualisation tool',
     'Miscellaneous'),
]
