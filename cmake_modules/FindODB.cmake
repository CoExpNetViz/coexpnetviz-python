...
# Modified by removing CACHE STRING from set calls as it caused trouble
...
function(find_odb_api component)
	...
	set(ODB_${component_u}_INCLUDE_DIRS ${ODB_${component}_INCLUDE_DIR})
	set(ODB_${component_u}_LIBRARIES ${ODB_${component}_LIBRARY})
